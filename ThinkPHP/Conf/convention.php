...
return  array(
    ...
    'MODULE_DENY_LIST'      =>  array('Common','Runtime'),//禁止URL访问的模块
    'CONTROLLER_LEVEL'      =>  1,
    ...
    'TMPL_ACTION_SUCCESS'   =>  THINK_PATH.'Tpl/dispatch_jump.tpl', // 默认成功跳转对应的模板文件，亦可使用下面的项目内部的模板文件
     'TMPL_EXCEPTION_FILE'   =>  THINK_PATH.'Tpl/think_exception.tpl',// 异常页面的模板文件
	
// 	'TMPL_ACTION_SUCCESS'   => 'Message:success',
// 	'TMPL_ACTION_ERROR'     => 'Message:success',
